  ...
  return (
    <div className={`${style.landingContainer}`}>
      <div className={`${style.navBar} ${style.animated} ${style.fromLeft}`}>
        <h3>CCMSystems</h3>
        <button className={`${style.logBtn} ${style.animatedReversed} ${style.fromTop}`} onClick={() => navigate("/auth")}>Log In</button>
      </div>
      <section className={style.hero}>
        <div className={style.heroLeft}>
          <h1 className={"fadeIn"}>Strong Systems for Stronger Structures.</h1>
          <div className={`${style.heroBtn} ${style.animated} ${style.fromLeft}`} onClick={() => navigate("/auth")}>Log in</div>
          <div className={`${style.heroBtn} ${style.animated} ${style.fromLeft}`} onClick={() => navigate("/auth")}>Contact Sales</div>
        </div>
        ...
        <div>
        <svg className={`${style.blob} fadeIn`} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          <path fill="#C6AC8F" >
            <animate 
            attributeName="d"
            calcMode={"paced"}
